  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-2">
        {(data?.findings || []).map((v) => (
          <Link key={v._id} to={`/findings/${v._id}`} className="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-slate-200 bg-white p-4 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-lg dark:border-slate-800 dark:bg-slate-900 dark:hover:border-cyan-400/30 dark:hover:shadow-[0_0_28px_-10px_rgba(34,211,238,0.5)]">
